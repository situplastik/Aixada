...
$Text['ti_mng_activate_preorders'] = "Convert punctual to order";
...
$Text['ti_report_preorder'] = "Summary of punctual";
...
$Text['nav_mng'] = "Manage";
	...
	$Text['nav_mng_orders'] = "Orders";
		...
		$Text['nav_mng_preorder'] = "Convert punctual to order";
...
$Text['nav_report_preorder'] = "Punctuals";
...
$Text['closed'] = "closed";
$Text['preorder_item'] = "This product forms part of an punctual order";
$Text['do_preorder'] = "Activate/deactivate as punctual";
$Text['do_deactivate_prod'] = "Activate/deactivate entire product";
$Text['msg_make_preorder_p'] = "You are about to set this product as *punctual*. It will be part of an punctual order which does not have any fixed order date (yet). People can order these items until a certain quantity has been reached and you close it. Are you sure you want to continue?";
$Text['msg_delete_preorder_p'] = "Are you sure to delete this punctual order?";
...
$Text['msg_pre2Order'] = "Convert this punctual to a regular order. This will assign an order date, i.e. when the expected items will arrive.";
